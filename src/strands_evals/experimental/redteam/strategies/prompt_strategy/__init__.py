...
class PromptStrategy(AttackStrategy):
    ...
    def __init__(self, strategy_name: str, system_prompt_template: str, *, label: str | None = None) -> None:
    ...
    def run_attack(
        ...
        **kwargs: Any,
        ...
        system_prompt_template = self._system_prompt_template.replace("{max_turns}", str(max_turns))
