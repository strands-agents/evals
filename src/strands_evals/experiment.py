...
from .types.detector import ConfidenceLevel
...
class Experiment(Generic[InputT, OutputT]):
    ...
    def __init__(
        ...
        diagnosis_model: "Model | str | None" = None,
        diagnosis_confidence_threshold: ConfidenceLevel = "low",
    ):
        ...
        self._diagnosis_confidence_threshold = diagnosis_confidence_threshold
    ...
    async def _run_diagnosis(
        ...
        try:
            result = await asyncio.to_thread(
                ...
                confidence_threshold=self._diagnosis_confidence_threshold,
            )
